...
### Variable Codebook
The full variable codebook with variable name, label, storage type and their corresponding values and value labels is available [here](data/raw_data/codebook.html)
