...
*plot1
coefplot $plot_y1  , ///
	keep(1.treated#1.LOWdep#*.year) vertical ///
	omitted baselevels ///
	msymbol(d) ///
	ciopts(recast(rcap)) levels(95) ///
	coeflabels(1.treated#1.LOWdep#2014.year="2014" 1.treated#1.LOWdep#2015.year="2015" ///
	1.treated#1.LOWdep#2016.year="2016" 1.treated#1.LOWdep#2018.year="2018" 1.treated#1.LOWdep#2017.year="2017" ///
	1.treated#1.LOWdep#2019.year="2019"	1.treated#1.LOWdep#2020.year="2020") ///
	xline(5 6 7, lwidth(1.5cm) lpattern(solid) lcolor(gs15)) ///
	yline(0) ///
	title("",size(medsmall))  ///
	legend(cols(3) pos(6) ring(1) label(2 "# of new positions") label(4 "# of new positions (excl. promotions)"))
